...
@Autonomous(name= "DetectBlueSS", group="Sky autonomous")
//@Disabled//comment out this line before using
public class DetectBlueSS extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            if(valLeft < 100) {
                ...
                mc.leftFoundation.setPosition(0.475); //up posiiton
                mc.rightFoundation.setPosition(0.475);
                sleep(300);
                ...
                mc.EncoderStrafe(30, this);
                mc.rotate(80, 1, this);
                mc.leftFoundation.setPosition(0.55); //up posiiton
                mc.rightFoundation.setPosition(0.55);
                sleep(500);
                mc.autonHook.setPosition(0.27);
                mc.autonClamp.setPosition(0.2);
                ...
                mc.EncoderMove(-90-8-8-4.5, this);
                mc.EncoderStrafe(-9.5, this);
                mc.autonHook.setPosition(0.27);
                sleep(300);
                mc.autonClamp.setPosition(0.2);
                ...
                mc.autonHook.setPosition(0);
                mc.EncoderStrafe(8.5, this);
                mc.EncoderMove(90-24+12+8+8, this);
                sleep(100);
                ...
                mc.EncoderMove(-90+24-4-8-8, this);
